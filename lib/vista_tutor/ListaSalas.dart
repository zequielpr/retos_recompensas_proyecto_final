  ...
  static Widget getInstance(
    ...
    return StreamBuilder(
      stream: collecionUsuarios
          .doc(idUserActual)
          .collection('rolTutor')
          .snapshots(), //Obtiene la colleccion que contiene todas la salas y la recorre
              ...
              return Padding(
                ...
                child: FlatButton(
                  ...
                  onPressed: () {
                    ...
                    SalaDatos sala = SalaDatos(collecionUsuarios
                        .doc(idUserActual)
                        .collection('rolTutor')
