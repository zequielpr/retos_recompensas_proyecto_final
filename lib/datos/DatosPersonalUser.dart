...
class DatosPersonales{
  ...
  static Widget getIndicadoAvance(String id_user_tutorado, CollectionReference collectionReferenceUsers, String idTutor){
    return StreamBuilder(
        stream: collectionReferenceUsers.doc(id_user_tutorado).collection('rolTutorado').doc(idTutor).snapshots(),
